...
export const IGM_UY = {
  ...
  departamento_uy: {
    ...
    attributes: [
      { campo: 'codigo', label: 'Código ISO', visible: true },
      { campo: 'depto', label: 'Nombre', visible: true },
      { campo: 'descripcio', label: 'Descripción', visible: true },
      { campo: 'def', label: 'Def', visible: false },
      { campo: 'shape_leng', label: 'Shape leng', visible: false },
      { campo: 'txt', label: 'Txt', visible: false },
      { campo: 'obs', label: 'Obs', visible: false },
      { campo: 'fcode', label: 'Fcode', visible: false },
      { campo: 'acc', label: 'Acc', visible: false },
      { campo: 'use_', label: 'Use ', visible: false },
      { campo: 'shape_stle', label: 'Shape stle', visible: false },
      { campo: 'globalid_1', label: 'Globalid 1', visible: false },
      { campo: 'sde_state_id', label: 'Sde state id', visible: false },
    ]
  },
  ...
  municipio_uy: {
    ...
    attributes: [
      { campo: 'f_code', label: 'F code', visible: false },
      { campo: 'descriptio', label: 'Descripción', visible: true },
      { campo: 'ara', label: 'Ara', visible: false },
      { campo: 'arh', label: 'Arh', visible: false },
      { campo: 'acc', label: 'Acc', visible: false },
      { campo: 'bst', label: 'Bst', visible: false },
      { campo: 'codigo', label: 'Código', visible: true },
      { campo: 'nombre', label: 'Nombre', visible: true },
      { campo: 'poblacion', label: 'Población', visible: true, numeric: true },
      { campo: 'alias', label: 'Alias', visible: true },
      { campo: 'cedi', label: 'Cedi', visible: false },
      { campo: 'cod', label: 'Código departamento', visible: true },
      { campo: 'use_', label: 'Use ', visible: false },
      { campo: 'seccionales', label: 'Seccionales', visible: false },
      { campo: 'txt', label: 'Txt', visible: false },
      { campo: 'escala', label: 'Escala', visible: false },
      { campo: 'seccionpol', label: 'Seccionpol', visible: false },
      { campo: 'areaadmini', label: 'Areaadmini', visible: false },
      { campo: 'shape_star', label: 'Shape star', visible: false },
      { campo: 'shape_stle', label: 'Shape stle', visible: false },
      { campo: 'shape_leng', label: 'Shape leng', visible: false },
      { campo: 'sde_state_id', label: 'Sde state id', visible: false },
    ]
  ...
  seccion_judicial_uy: {
    ...
    attributes: [
      ...
      { campo: 'acc', label: 'Acc', visible: false },
      { campo: 'bst', label: 'Bst', visible: false },
      { campo: 'nm3', label: 'Nm3', visible: false },
      { campo: 'nm4', label: 'Nm4', visible: false },
      { campo: 'use_', label: 'Use ', visible: false },
      { campo: 'txt', label: 'Txt', visible: false },
      { campo: 'hoja', label: 'Hoja', visible: false },
      { campo: 'nam', label: 'Nam', visible: true },
      { campo: 'localidad', label: 'Localidad', visible: true },
      { campo: 'depto', label: 'Departamento', visible: true },
      { campo: 'escala', label: 'Escala', visible: false },
      { campo: 'shape_star', label: 'Shape star', visible: false },
      { campo: 'shape_stle', label: 'Shape stle', visible: false },
      { campo: 'fid_secjud', label: 'Fid secjud', visible: false },
      { campo: 'numero', label: 'Número de sección', visible: true, numeric: true },
      { campo: 'shape_leng', label: 'Shape leng', visible: false },
      { campo: 'st_area_shape', label: 'St area shape', visible: false },
      { campo: 'st_perimeter', label: 'St perimeter', visible: false },
      { campo: 'sde_state_id', label: 'Sde state id', visible: false },
    ]
  },
  ...
  limite_terrestre_uy: {
    ...
    attributes: [
      { campo: 'def', label: 'Definición', visible: true },
      { campo: 'obs', label: 'Obs', visible: false },
      { campo: 'fcode', label: 'Fcode', visible: false },
      { campo: 'acc', label: 'Acc', visible: false },
      { campo: 'bst', label: 'Bst', visible: false },
      { campo: 'mn3', label: 'Mn3', visible: false },
      { campo: 'mn4', label: 'Mn4', visible: false },
      { campo: 'txt', label: 'Txt', visible: false },
  ...
  limite_marino_uy: {
    ...
    attributes: [
      { campo: 'def', label: 'Definición', visible: true },
      { campo: 'obs', label: 'Tipo de límite', visible: true, classifiable: true },
      { campo: 'fcode', label: 'Fcode', visible: false },
      { campo: 'acc', label: 'Acc', visible: false },
      { campo: 'bst', label: 'Bst', visible: false },
      { campo: 'mn3', label: 'Mn3', visible: false },
  ...
  rio_area_uy: {
    ...
    attributes: [
      { campo: 'f_code', label: 'F code', visible: false },
      { campo: 'descriptio', label: 'Tipo', visible: true, classifiable: true },
      { campo: 'nam', label: 'Nombre', visible: true },
      { campo: 'hyc', label: 'Hyc', visible: false },
      { campo: 'exs', label: 'Exs', visible: false },
      { campo: 'acc', label: 'Acc', visible: false },
      { campo: 'wid', label: 'Ancho (m)', visible: true, numeric: true },
      { campo: 'tid', label: 'Tid', visible: false },
      { campo: 'localidad', label: 'Localidad', visible: false },
      { campo: 'depto', label: 'Departamento', visible: true },
      { campo: 'hoja', label: 'Hoja', visible: false },
      { campo: 'txt', label: 'Txt', visible: false },
      { campo: 'escala', label: 'Escala', visible: false },
      { campo: 'rioarroyoc', label: 'Rioarroyoc', visible: false },
      { campo: 'rioarroy_2', label: 'Rioarroy 2', visible: false },
      { campo: 'shape_star', label: 'Shape star', visible: false },
      { campo: 'shape_stle', label: 'Shape stle', visible: false },
      { campo: 'sde_state_id', label: 'Sde state id', visible: false },
    ]
  ...
  rio_linea_uy: {
    ...
    attributes: [
      ...
      { campo: 'exs', label: 'Exs', visible: false },
      { campo: 'acc', label: 'Acc', visible: false },
      { campo: 'wid', label: 'Wid', visible: false },
      { campo: 'tid', label: 'Tid', visible: false },
      { campo: 'localidad', label: 'Localidad', visible: false },
      { campo: 'depto', label: 'Departamento', visible: true },
      { campo: 'hoja', label: 'Hoja', visible: false },
      { campo: 'txt', label: 'Txt', visible: false },
      { campo: 'escala', label: 'Escala', visible: false },
      { campo: 'tiporio', label: 'Tipo de río', visible: true, classifiable: true },
      { campo: 'rioarroyoc', label: 'Rioarroyoc', visible: false },
      { campo: 'shape_stle', label: 'Shape stle', visible: false },
      { campo: 'sde_state_id', label: 'Sde state id', visible: false },
    ]
  ...
  limite_hist_1835_area_uy: {
    ...
    attributes: [
      { campo: 'objectid_1', label: 'Objectid 1', visible: false },
      { campo: 'departamen', label: 'Departamento', visible: true },
      { campo: 'acc', label: 'Acc', visible: false },
      { campo: 'bst', label: 'Bst', visible: false },
      { campo: 'use_', label: 'Use ', visible: false },
      { campo: 'nm3', label: 'Nm3', visible: false },
