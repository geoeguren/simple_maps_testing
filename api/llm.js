...
[{"layerKey":"...","color":"#hex","fillColor":"#hex","fillOpacity":0.5,"weight":2,"opacity":1,"radius":6}]
\`\`\`
Solo incluí los campos que el usuario quiera cambiar. layerKey es SIEMPRE la clave del catálogo (ej: "provincia_ar", "puertos_ar", "vial_nacional_ar") — nunca uses identificadores internos como "provincia_ar_0".
